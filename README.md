...
* Download the jqGrid package from the [site section downloads](http://www.trirand.com/blog/). Get the i18n folder and jquery.jqGrid.min.js, jquery-1.9.0.min.js files and copy them in "src/js" folder of this project. Then get the ui.jqgrid.css file and copy it in "src/css" folder of this project.
